   ...
   <Container maxWidth='xl' sx={{ py: 6 }}>
      ...
      >
        ...
        <Typography variant="body1" paragraph>
          ...
          <strong>NexaDriveAutomation</strong> services and products, you agree
          to comply with the following terms and conditions. Please read them
          carefully before making use of our offerings.
        </Typography>
        ...
        <List dense>
          <ListItem>Follow installation and usage guidelines provided by us.</ListItem>
          <ListItem>Avoid modifications, reverse engineering, or tampering.</ListItem>
          <ListItem>Refrain from unauthorized resale or distribution.</ListItem>
        </List>
        ...
        <List dense>
          ...
          <ListItem>Damage is caused by external factors beyond our control.</ListItem>
        ...
        <Typography variant="body1" paragraph>
          We are not liable for damages or losses arising from the misuse of our
          products or services. Customers are responsible for ensuring proper
          installation, maintenance, and safe operation of equipment.
        </Typography>
